        ...
        <div class="row align-items-center">
            <div class="col-xl-11 col-lg-10">
                <p class="m-0 text-white small fw-light">
                    <a href="dashboard.php" class="text-white text-decoration-none ">Dashboard</a> >> Purchases >> <a href="purchase-return.php" class="text-decoration-none fw-bold"><span class="text-warning">Purchase Return</span></a>
                </p>
            </div>
     ...
     <table class="table my_custom_datatable table-bordered mt-3" id="purchase_tbl">
        ...
        <?php 
               ...
               if (!empty($all_value)) {
                ...
                $purchase  = $this->User_model->get_purchase_details($value->m_purchase_spo,$value->supplier_id)[0];  
            ...
            <!-- <td><span class="badge bg-success"><?php if($value->m_purchase_status ==1){ echo 'Running';}else if($value->m_purchase_status ==2){ echo 'Delivered';}else{ echo 'New';} ?></span></td> -->
            <td>₹<?php echo $value->paid_amount; ?></td>
            <td>₹<?php echo $balance; ?></td>
            <td><span class="badge bg-success"><?php if($value->m_purchase_pstatus ==1){ echo 'Paid';}else{ echo 'Un-paid';} ?></span></td>
            ...
            <td>
                ...
                <div class="offcanvas offcanvas-end" data-bs-backdrop="static" tabindex="-1" id="staticBackdrop1<?php echo $value->m_purchase_spo; ?>" aria-labelledby="staticBackdropLabel">
                    ...
                    <div class="offcanvas-header">
                        <h5 class="offcanvas-title" id="staticBackdropLabel"><?php echo $value->m_purchase_invoiceno; ?> (Invoice Number) <span class="badge bg-success"><?php if($value->m_purchase_pstatus ==1){ echo 'Paid';}else{ echo 'Un-paid';} ?></span></h5>
                            ...
                            <div class="row g-4">
                                <div class="col-md-12">
                                    <div class="row g-4">
                                        ...
                                        <!-- <div class="col-4">
                                            Order Status :<br> <span class="badge bg-success"><?php if($value->m_purchase_status ==1){ echo 'Running';}else if($value->m_purchase_status ==2){ echo 'Delivered';}else{ echo 'New';} ?></span>
                                        </div> -->
                                        <div class="col-4">
                                            Payment Status :<br> <span class="badge bg-success"><?php if($value->m_purchase_pstatus ==1){ echo 'Paid';}else{ echo 'Un-paid';} ?></span>
                                        </div>
                                        <div class="col-4">
                           ...
                           <div class="tab-pane fade show active " id="payment-tab-pane<?php echo $value->m_purchase_spo; ?>" role="tabpanel" aria-labelledby="payment-tab" tabindex="0">
                                            <table class="table table-bordered">
                                                <tr>
                                                 ...
                                                 <?php foreach ($purchase['product_payment'] as $val){ ?>
                                                <tr>
                                        ...
                                        <div class="tab-pane fade" id="order-tab-pane<?php echo $value->m_purchase_spo; ?>" role="tabpanel" aria-labelledby="order-tab" tabindex="0">
                                            ...
                                            <tbody>
                                                <?php foreach ($purchase['m_purchase_items'] as $val){ ?>
                                                    <tr>
                ...
                <a href="<?php echo base_url('User/edit_purchase?id=').$value->m_purchase_spo.'&purtype=2'.'&rdid=1';  ?>"><button type="button" class="btn btn-primary btn-sm"><i class="fa-solid fa-pen-to-square"></i></button></a>
