...
<section style="min-height: 75vh;" class="pb-5">
    <div class="container-fluid bg-light p-3">
        <div class="row g-3">
            <div class="col-md-3">
                <div class="card dash1 p-3" style="background: url('<?php echo base_url();?>assets/imgs/pattern.png'), linear-gradient(45deg, #0288d1, #26c6da);">
                    <div class="row">
                        <div class="col-4">
            ...
            <div class="col-md-3">
                <div class="card dash3 p-3" style="background:url('<?php echo base_url();?>assets/imgs/pattern.png'), linear-gradient(45deg, #ff6f00, #ffca28)" ;>
                    <div class="row">
                        <div class="col-4">
            ...
            <div class="col-md-3">
                <div class="card dash2 p-3" style="background:url('<?php echo base_url();?>assets/imgs/pattern.png'), linear-gradient(45deg, #ff5252, #f48fb1)" ;>
                    <div class="row">
                        <div class="col-4">
            ...
            ?>
            <div class="col-md-3">
                <div class="card dash4 p-3" style="background:url('<?php echo base_url();?>assets/imgs/pattern.png'), linear-gradient(45deg, #43a047, #1de9b6)">
                    <div class="row">
                        <div class="col-4">
        ...
        <?php } ?>
            <div class="col-md-3">
                <div class="card dash5 p-3" style="background:url('<?php echo base_url();?>assets/imgs/pattern.png'), linear-gradient(to right, #ad5389, #3c1053)">
                    <div class="row">
                        <div class="col-4">
            ...
            <div class="col-md-3">
                <div class="card dash6 p-3" style="background:url('<?php echo base_url();?>assets/imgs/pattern.png'), linear-gradient(to right, #000046, #1cb5e0)">
                    <div class="row">
                        <div class="col-4">
            ...
            <div class="col-md-3">
                <div class="card dash7 p-3" style="background:url('<?php echo base_url();?>assets/imgs/pattern.png'), linear-gradient(45deg, #cd1d1d, #ff6161)">
                    <div class="row">
                        <div class="col-4">
