        ...
        <div class="row align-items-center">
            <div class="col-xl-10 col-lg-10">
                <p class="m-0 text-white small fw-light">
                    <a href="<?php echo base_url('Dashboard');?>" class="text-white text-decoration-none ">Dashboard</a> >> Purchase >> <a href="<?php echo base_url('User/payment_out');?>" class="text-decoration-none fw-bold"><span class="text-warning"> Payment out</span></a>
                </p>
            </div>
        ...
        <div class="col-md-7">
         ...
         <div class="col-md-5">
            <div class="input-group form-group">
                <form method="get" action="<?php echo base_url('User/payment_out');  ?>">
                ...
                <a type="submit" href="<?php echo base_url('User/payment_out');  ?>" class="btn btn-primary me-2" data-mdb-ripple-init>
                   <i class="fa-solid fa-rotate"></i>
                </a>
                </form>
                <form action="<?php echo base_url('User/payment_out');?>"  method="get" >
            ...
            <td><button type="button" class="btn btn-primary btn-sm" data-bs-toggle="offcanvas" data-bs-target="#staticBackdrop<?php echo $value->m_payment_id; ?>" aria-controls="staticBackdrop"><i class="fa-solid fa-pen-to-square"></i></button>
                ...
                <div class="offcanvas offcanvas-end" data-bs-backdrop="static" tabindex="-1" id="staticBackdrop<?php echo $value->m_payment_id; ?>" aria-labelledby="staticBackdropLabel">
                    ...
                    <div class="offcanvas-body">
                        <div>
                           <form class="row g-4" method="POST" id="form_paymentout_edit">
                                <div class="col-md-12">
                                ...
                                <div class="canvas-footer justify-content-end d-flex">
                                    <button type="submit" class="btn btn-primary me-2" id="btn_paymentout_edit"><i class="fa-regular fa-pen-to-square"></i> Update</button>
...
<div class="offcanvas offcanvas-end" data-bs-backdrop="static" tabindex="-1" id="staticBackdropadd" aria-labelledby="staticBackdropLabel">
                    ...
                    <div class="offcanvas-body">
                        <div>
                            <form class="row g-4" method="POST" id="form_paymentout_add">
                                <div class="col-md-12">
                                    <label for="Name">Supplier<span class="text-danger">*</span></label>
                                ...
                                <div class="canvas-footer justify-content-end d-flex">
                                    <button type="submit" class="btn btn-primary me-2" id="btn_paymentout_add"><i class="fa-regular fa-pen-to-square"></i> Add</button>
                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="offcanvas" aria-label="Close" data-bs-dismiss="modal">Cancel</button>
                                </div>
                            </form>
                        </div>
