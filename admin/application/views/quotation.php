        ...
        <div class="row align-items-center">
            <div class="col-xl-10 col-lg-10">
                <p class="m-0 text-white small fw-light">
                    <a href="<?php echo base_url('Dashboard');?>" class="text-white text-decoration-none ">Dashboard</a> >> Sales >> <a href="<?php echo base_url('User/quotation');?>" class="text-decoration-none fw-bold"><span class="text-warning"> Quotation</span></a>
                </p>
            </div>
...
<div class="container-fluid bg-light">
    <div class="row pt-3">
        <div class="col-md-7">
            <button type="button" class="btn btn-primary btn-sm"><i class="fa-solid fa-plus"></i> Add New Quotation</button>
        </div>
        <div class="col-md-5">
    ...
    <table class="table table-bordered mt-3">
        ...
        <tr>
            ...
            <td>₹00.00</td>
            <td>₹123.00</td>
            <td><span class="badge bg-danger text-dark">Unpaid</span></td>
            <td>
                <button type="button" class="btn btn-primary btn-sm" data-bs-toggle="offcanvas" data-bs-target="#staticBackdrop1" aria-controls="staticBackdrop"><i class="fas fa-eye"></i></button>
                ...
                <a href="<?php echo base_url('User/edit_quotation');  ?>"><button type="button" class="btn btn-primary btn-sm"><i class="fa-solid fa-pen-to-square"></i></button></a>
