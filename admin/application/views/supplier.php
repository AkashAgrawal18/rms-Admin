        ...
        <div class="row align-items-center">
            <div class="col-xl-11 col-lg-10">
                <p class="m-0 text-white small fw-light">
                    <a href="<?php echo base_url('Dashboard');?>" class="text-white text-decoration-none ">Dashboard</a> >> Parties >> <a href="<?php echo base_url('User/supplier');?>" class="text-decoration-none fw-bold"><span class="text-warning"> Suppliers</span></a>
                </p>
            </div>
    ...
    <div class="row pt-3">
        ...
        <div class="col-md-5">
            <div class="input-group form-group">
                <form method="get" action="<?php echo base_url('User/supplier');  ?>">
                ...
                <a type="submit" href="<?php echo base_url('User/supplier');  ?>" class="btn btn-primary me-2" data-mdb-ripple-init>
                   <i class="fa-solid fa-rotate"></i>
                </a>
                </form>
                <form action="<?php echo base_url('User/supplier');?>"  method="get" >
...
<hr>
<form method="POST" action="<?php echo site_url('User/import_supplier') ?>" enctype="multipart/form-data">
