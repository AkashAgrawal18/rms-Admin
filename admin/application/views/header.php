    ...
    <div class="container-fluid d-flex align-items-center justify-content-start">
        <div class="d-inline-flex justify-content-start px-2 gap-2">
            <a href="#" class="d-block text-dark main-link active">
                <img src="<?php echo base_url(); ?>assets/icons/user.png" alt="" class="w-50 mx-auto mt-1" />
                <p class="m-0">
                    Add User
                </p>
            </a>
        ...
        <div class="d-inline-flex justify-content-start px-2 gap-1">
            <a href="<?php echo base_url('Dashboard'); ?>" class="d-block text-dark py-1 main-link">
                <img src="<?php echo base_url(); ?>assets/icons/dash.png" alt="" class="w-50 mx-auto" />
                <p class="m-0">
                    Dashboard
                </p>
            </a>
            <a href="<?php echo base_url('Main/pos'); ?>" class="d-block text-dark py-1 main-link">
                <img src="<?php echo base_url(); ?>assets/icons/order.png" alt="" class="w-50 mx-auto" />
                <p class="m-0">
                    POS
                </p>
            </a>
            <a href="<?php echo base_url('Main/cash_bank');  ?>" class="d-block text-dark py-1 main-link">
                <img src="<?php echo base_url(); ?>assets/icons/product.png" alt="" class="w-50 mx-auto" />
                <p class="m-0">
                    Cash & Bank
                </p>
            </a>
            <a href="<?php echo base_url('Main/offer'); ?>" class="d-block text-dark py-1 main-link">
                <img src="<?php echo base_url(); ?>assets/icons/gift.png" alt="" class="w-50 mx-auto" />
                <p class="m-0">
                    Offers
                </p>
            </a>
            <a href="<?php echo base_url('Main/coupons'); ?>" class="d-block text-dark py-1 main-link">
                <img src="<?php echo base_url(); ?>assets/icons/coupon.png" alt="" class="w-50 mx-auto" />
                <p class="m-0">
                    Coupons
                </p>
            </a>
        ...
        <div class="d-inline-flex justify-content-start px-2 gap-1">
            <a href="<?php echo base_url('Main/banner'); ?>" class="d-block text-dark py-1 main-link">
                <img src="<?php echo base_url(); ?>assets/icons/banner.png" alt="" class="w-50 mx-auto" />
                <p class="m-0">
                    Banners
                </p>
            </a>
            <a href="<?php echo base_url('Query/queries'); ?>" class="d-block text-dark py-1 main-link">
                <img src="<?php echo base_url(); ?>assets/icons/query.png" alt="" class="w-50 mx-auto" />
                <p class="m-0">
                    Queries
                </p>
            </a>
            <a href="<?php echo base_url('Query/review'); ?>" class="d-block text-dark py-1 main-link">
                <img src="<?php echo base_url(); ?>assets/icons/review.png" alt="" class="w-50 mx-auto" />
                <p class="m-0">
                    Reviews
                </p>
            </a>
            <!-- <a href="#" class="d-block text-dark py-1 main-link">
                <img src="<?php echo base_url(); ?>assets/icons/purchase.png" alt="" class="w-50 mx-auto" />
                <p class="m-0">
                    Purchase
                </p>
            </a> -->
        ...
        <div class="d-inline-flex justify-content-start px-2 gap-1">
            <!-- <a href="#" class="d-block text-dark py-1 main-link">
                <img src="<?php echo base_url(); ?>assets/icons/bann.png" alt="" class="w-50 mx-auto" />
                <p class="m-0">
                    Banners
                </p>
            </a> -->
            <a href="#" class="d-block text-dark py-1 main-link">
                <img src="<?php echo base_url(); ?>assets/icons/master.png" alt="" class="w-50 mx-auto" />
                <p class="m-0">
                    Masters
                </p>
            </a>
            <a href="#" class="d-block text-dark py-1 main-link">
                <img src="<?php echo base_url(); ?>assets/icons/delivery.png" alt="" class="w-50 mx-auto" />
                <p class="m-0">
                    Delivery Management
                </p>
            </a>
            <!-- <a href="#" class="d-block text-dark py-1 main-link">
                <img src="<?php echo base_url(); ?>assets/icons/accounting.png" alt="" class="w-50 mx-auto" />
                <p class="m-0">
                    Balance
                </p>
            </a> -->
        ...
        <div class="d-inline-flex justify-content-start px-2 gap-1">
            <a href="<?php echo base_url('Setting/profile'); ?>" class="d-block text-dark py-1 main-link">
                <img src="<?php echo base_url(); ?>assets/icons/profile.png" alt="" class="w-50 mx-auto" />
                <p class="m-0">
                    Profile
                </p>
            </a>
            <a href="<?php echo base_url('Logout') ?>" class="d-block text-dark py-1 main-link">
                <img src="<?php echo base_url(); ?>assets/icons/logout.png" alt="" class="w-50 mx-auto" />
                <p class="m-0">
                    Logout
                </p>
            </a>
          <!--   <a href="#" class="d-block text-dark py-1 main-link">
                <img src="<?php echo base_url(); ?>assets/icons/cross.png" alt="" class="w-50 mx-auto" />
                <p class="m-0">
                    Exit
                </p>
            </a> -->
