...
<body>
    <header class="py-3 fixed-top" style="background: #003176">
            ...
            <div class="row">
                <div class="col-1">
                    <?php
                      ...
                      ?>
                    <img src="<?php echo $fav_img;?>" alt="" style="height: 50px;" class="w-100">
                </div>
            </div>
        </div>
    </header>
    <section class="main-wrapper d-flex align-items-center"
        style="min-height: 100vh; padding: 10vh 5vw; background:url('<?php echo base_url();?>assets/imgs/billbg.jpg');background-size:cover;">
        <div class="container-fluid">
            <div class="row">
                <div class="col-lg-4">
                    <div class="card p-3 rounded-4">
                        <h4 class="m-0 mb-1 fw-bold">Admin Login</h4>
